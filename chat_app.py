...
class ChatApp:
    ...
    def open_add_members_window(self, group_name):
        if group_name in self.group_chat_windows:
            ...
            # Fetch group members from the group_chat_windows dictionary
            group_members_list = self.group_members.get(group_name, [])
            # Fetch contacts that are not yet members of the group
            ...
            # Display the list of contacts in a Listbox
